                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_Product" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="abv" id="list-title" type="text" class="validate" required>
                                    <label for="list-title">Alcohol Percentage</label>
                                </div>
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="origin" id="list-title" type="text" class="validate" required>
                                    <label for="list-title">Origin</label>
                                </div>
                                <div class="input-field col s12">
