                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="cart-item">
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="product-single.html">
                                            <img src="{{asset('theme/assets/images/products/wines/product-02.png')}}" alt="Product" width="70" height="89" />
                                        </a>
                                    </td>
                                ...
                                <tr class="cart-item">
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="product-single.html">
                                            <img src="{{asset('theme/assets/images/products/wines/product-04.png')}}" alt="Product" width="70" height="89" />
                                        </a>
                                    </td>
                                ...
                                <tr class="cart-item">
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="product-single.html">
                                            <img src="{{asset('theme/assets/images/products/wines/product-05.png')}}" alt="Product" width="70" height="89" />
                                        </a>
                                    </td>
